...
public class ActorInvocationUpdateStateBenchmark extends AbstractBenchmark {
    private static final Logger LOGGER = LoggerFactory.getLogger(ActorInvocationUpdateStateBenchmark.class);
